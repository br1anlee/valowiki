  ...
  return (
    <div>
      <div className="home-div center">
        ...
        <h4 className="container-h4">
          Valowiki is an app created for Valorant players who want to learn more
          about their favorite agents and also improve their gameplay.
        </h4>
        ...
        <h4 className="container-h4">
          ...
          game, developed by Riot Games. Set in a near-future Earth, you team up
        ...
        <h4>
          Click <Link to="/gameplay">here</Link> to see some gameplay!
        </h4>
        ...
        <div className="container-small">
          <small>
            Valowiki isn't endorsed by Riot Games and doesn't reflect the views
